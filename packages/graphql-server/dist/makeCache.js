        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, postgraphile_1.createPostGraphileSchema(pgPool, config_1.dbOptions.schemas, __assign(__assign({}, config_1.postgraphileOptions), { writeCache: __dirname + "/../postgraphile.cache" }))];
                case 1:
                    _a.sent();
